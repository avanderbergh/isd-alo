  ...
  ready() {
    ...
    new Promise((resolve, reject) => gapi.load("client:auth2", () => resolve()))
      ...
      .then(() => {
        gapi.auth2
          .getAuthInstance()
          .isSignedIn.listen(this._updateSigninStatus.bind(this));
      ...
      .catch(err => {
        console.error(err);
        alert(
          "Login failed! Please ensure that you have not enabled 'Block third party Cookies' in your browser settings"
        );
      });
